...
class UploadShopActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        latLng=LatLng(25.095340,83.725510)
...
*/
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.apply {
            ...
            addMarker(MarkerOptions().position(latLng).title(getString(R.string.app_name)))
    ...
    private fun setupToolbar() {
        supportActionBar?.apply {
            ...
            subtitle = "Your Shop Online Register"
        }
    }
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && ischeck == 1) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (place != null) {
                    ...
                    mMap.apply {
                        MapStyleOptions.loadRawResourceStyle(context, R.raw.map_style)
                        addMarker(MarkerOptions().position(latLng).title(address as String?))
                        moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, ZOOM))
                    }
